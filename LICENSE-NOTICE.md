...
This repository is a preview project.

The generator is intended to work with a Swiss Ephemeris compatible calculation backend and local `.se1` ephemeris files. The `.se1` files are not included.
